...
print("In exaclty 24 hours \
a delivery truck is going to come deliver food to the priosn")
...
# The user runs away from the guard
            ...
            if choice1.lower() == "run away":
                if "sharp object" in items:
                    ...
                    choice3 = input(wake_up)
# wake up the next morning
# User waits until delivery truck arrives
                if choice3.lower() == "act":
                    print("\nYou decided to act non suspicious until \
the truck comes")
                    print("Your almost out, dont let the nerves \
get to you!")
                    choice4 = input(escape_1)
# the user is able to escape using blueprint
                if choice4.lower() == "yes":
                    if "blueprints" in knowledge:
                        print("\nYou used your blueprints to navigate \
your way to the delivery truck \
...
# wake up
            if wake_up.lower() == "act":
                # User waits until delivery truck arrives
                print("\nYou decided to act non suspicious \
